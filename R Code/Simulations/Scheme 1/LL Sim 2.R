...
makeDataLL2 <- function(N, small, large, tau, NoSig, lam1, lam2, alpha1, alpha2){
	Bo_small <- .207
	Bo_large <- .845
...
# 0% censoring
dat0 <- makeDataLL2(N, numSmall, numLarge, "inf", notsig, 1,2,3,4)

# 33% censoring
dat33 <- makeDataLL2(N, numSmall, numLarge, 1.65, notsig, 1,2,3,4)

# 67% censoring
dat67 <- makeDataLL2(N, numSmall, numLarge, 0.7, notsig, 1,2,3,4)

# 80% censoring
dat80 <- makeDataLL2(N, numSmall, numLarge, 0.45, notsig, 1,2,3,4)